        ...
        <Box sx={{ display: "flex", gap: "40px", marginBottom: "30px" }}>
            ...
            <Box flex={1} display="flex" flexDirection="column" p={2} component={Paper} sx={{ border: "1px solid #ddd", borderRadius: "8px", height: "100%" , gap:"12px"}} >
                    ...
                    <React.Fragment key={index}>
                        ...
                        >
                            ...
                            sx={{
                                ...
                                backgroundColor: step.id === 1 || step.id === 2 ? "#182775" : "#F7F7FD",
                                color: step.id === 1 || step.id === 2? "#fff" : "#182775",
                                border: `2px solid ${step.id === 1 || step.id === 2? "#182775" : "#ddd"}`,
                        ...
                        sx={{
                            ...
                            fontSize: "16px",
                            fontWeight: "500",
                            color: step.id === 1 || step.id === 2? "#182775" : "#5C5C5C",
                            textAlign: "center",
                        }}
                        >
                        {step.label}
                ...
                <Box flex={1} overflow="auto" p={2} sx={{ backgroundColor: "#F7F7FD", borderRadius: "8px" }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "flex-start", mb: 2 }}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "12px", width: "360px" }}>
                            ...
                            <Box sx={{ bgcolor: "#FFFFFF", color: "#5C5C5C", p: 1, borderRadius: "10px", maxWidth: "410px" }}>
                                We work to solve the problem you are facing and maintenance is carried out as quickly as possible
                            </Box>
                ...
                <Box sx={{ display: "flex", gap: "16px", mt: 2 }}>
                    ...
                    >
                        <IconButton 
                            onClick={() => navigate("/dashboard/users-done")} 
                            sx={{ color: "#182775" }}
                        >
                            <SendIcon />
                        </IconButton>
